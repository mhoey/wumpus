...
200  REMLOCATE L ARRAY ITEMS
210  REM1-YOU,2-WUMPUS,3&4-PITS,5&6-BATS
220  DIM L(6)
230  DIM M(6)
240   FOR J=1 TO 6
250   L(J)=FNA(0)
260   M(J)=L(J)
270   NEXT J
280  REMCHECK FOR CROSSOVERS (IE L(1)=L(2),ETC)
290   FOR J=1 TO 6
300    FOR K=J TO 6
310    IF J=K THEN 330
...
380  REMHAZARD WARNINGS & LOCATION
390  GOSUB 2000
400  REMMOVE OR SHOOT
410  GOSUB 2500
...
1400  PRINT ""
1410  RETURN
2000  REMPRINT LOCATION & HAZARD WARNINGS
2010  PRINT
2020   FOR J=2 TO 6
2030    FOR K=1 TO 3
...
2570  O=2
2580  RETURN
3000  REMARROW ROUTINE
3010  F=0
3020  REMPATH OF ARROW
3030  DIM P(5)
...
3270  F=-1
3280  RETURN
3290  REMSEE IF ARROW IS AT L(1) OR L(2)
3295  L=P(K)
